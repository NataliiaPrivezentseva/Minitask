...
public class TaskFragment extends Fragment {
    ...
    FirebaseRecyclerOptions<ToDoItem> getToDoItemFirebaseRecyclerOptions() {
        ...
        return new FirebaseRecyclerOptions.Builder<ToDoItem>()
                .setQuery(query, ToDoItem.class)
                .build();
    }

    void createOnClickListener(FirebaseViewHolder viewHolder, final ToDoItem toDoItem) {
    ...
    void createOnCheckedListener(final FirebaseViewHolder viewHolder, final int position, final ToDoItem toDoItem) {
